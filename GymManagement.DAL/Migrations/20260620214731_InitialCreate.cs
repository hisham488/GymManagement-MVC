        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("_PhoneCheck", "Phone LIKE '010%' or Phone LIKE '011%' or Phone LIKE '015%' or Phone LIKE '012%'");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("PlanDurationCheck", "DurationDays Between 1 and 360");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("_PhoneCheck1", "Phone LIKE '010%' or Phone LIKE '011%' or Phone LIKE '015%' or Phone LIKE '012%'");
